...
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. NovaCare detects an invalid patient ID.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. NovaCare requests for valid patient ID.")])]),_v(" "),_c('li',[_c('p',[_v("3a2. User enters a new patient ID and description of the task.")]),_v(" "),_c('p',[_v("Steps 3a1-3a2 are repeated until the data entered is correct.\nUse case resumes at step 2 if patient details are re-entered.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Nurse chooses to delete an emergency contact number for a patient.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare requests the patient's details to identify the patient.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare displays the list of current emergency contacts for the patient.")])]),_v(" "),_c('li',[_c('p',[_v("Nurse selects the contact to delete.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare requests confirmation from the nurse to delete the selected contact.")])]),_v(" "),_c('li',[_c('p',[_v("Nurse confirms the deletion.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare deletes the selected emergency contact and displays a confirmation message with the updated emergency contact list.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. The list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. NovaCare detects that the patient does not exist.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. NovaCare notifies the nurse that the patient does not exist.")])]),_v(" "),_c('li',[_c('p',[_v("3a2. Nurse either re-enters the correct patient details or cancels the operation.")]),_v(" "),_c('p',[_v("Use case resumes at step 2 if patient details are re-entered.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Thu, 17 Oct 2024, 11:24:52 GMT+8]")])])])}
}];
