...
with(this){return _c('p',[_v("The data archiving feature allows for the backup and restoration of data by compressing it into a single archive file (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v(".zip")]),_v("). This feature can be useful for storage and data retrieval.")])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('strong',[_v("Collect Data")]),_v(": Identify and gather all necessary data files.")]),_v(" "),_c('li',[_c('strong',[_v("Compress Data")]),_v(": Compress these files into an archive.")]),_v(" "),_c('li',[_c('strong',[_v("Store Archive")]),_v(": Save the archive to a specified location.")]),_v(" "),_c('li',[_c('strong',[_v("Retrieve Data")]),_v(": Extract the archive when restoration is required.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("nurse in the healthcare industry managing patients")]),_v(" "),_c('li',[_v("has many patients across different wards with varying care levels")]),_v(" "),_c('li',[_v("Mainly done in desktop app")]),_v(" "),_c('li',[_v("Used to typing to fill out user information")]),_v(" "),_c('li',[_v("is comfortable using CLI")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to add a new patient.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare prompts for the patient's relevant details.")])]),_v(" "),_c('li',[_c('p',[_v("User inputs the required information.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare outputs a message showing successful patient creation.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. NovaCare detects an invalid phone number or email.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. NovaCare requests valid phone number and/or email.")])]),_v(" "),_c('li',[_c('p',[_v("3a2. User re-enters the phone number and/or email.")]),_v(" "),_c('p',[_v("Steps 3a1-3a2 are repeated until the data entered is correct.\nUse case resumes at step 3 if the details are re-entered.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. User omits one or more required fields (name, phone number, email or address).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. NovaCare prompts the user to enter the missing fields.")])]),_v(" "),_c('li',[_c('p',[_v("3b2. User provides the missing information.")]),_v(" "),_c('p',[_v("Steps 3b1-3b2 are repeated until all required fields are provided.\nUse case resumes at step 3 once all fields are correctly entered.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: UC02 - Delete Patient")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to add a new task.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare asks for a patient ID and description of the task.")])]),_v(" "),_c('li',[_c('p',[_v("User inputs the requested information.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare outputs message showing successful task creation.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. The patient list is empty.")]),_v(" "),_c('p',[_v("Use case ends.")])]),_v(" "),_c('li',[_c('p',[_v("3a. NovaCare detects an invalid patient ID.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. NovaCare requests for valid patient ID.")])]),_v(" "),_c('li',[_c('p',[_v("3a2. User enters a new patient ID and description of the task.")]),_v(" "),_c('p',[_v("Steps 3a1-3a2 are repeated until the data entered is correct.\nUse case resumes at step 2 if patient details are re-entered.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: UC04 - Delete Task")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to delete a task.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare asks for the Task ID of the task to be deleted.")])]),_v(" "),_c('li',[_c('p',[_v("User inputs the Task ID.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare outputs a message showing successful deletion of the task.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The task list is empty.")]),_v(" "),_c('ul',[_c('li',[_v("Use case ends.")])])]),_v(" "),_c('li',[_c('p',[_v("3a. NovaCare detects an invalid Task ID.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. NovaCare requests a valid Task ID.")])]),_v(" "),_c('li',[_c('p',[_v("3a2. User enters a new Task ID.")]),_v(" "),_c('p',[_v("Steps 3a1-3a2 are repeated until the data entered is correct.\nUse case resumes at step 2 if patient details are re-entered.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC05 - Add Emergency contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to add emergency contact details to a selected patient.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare asks for a patient ID, emergency contact name, and emergency contact number.")])]),_v(" "),_c('li',[_c('p',[_v("User inputs the requested information.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare adds the emergency contact to the selected patient and displays a confirmation message with the updated emergency contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. NovaCare detects that the patient already has a registered emergency contact.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. NovaCare notifies the user that the patient already has a registered emergency contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. NovaCare detects that the patient does not exist.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. NovaCare notifies the user that the patient does not exist.")])]),_v(" "),_c('li',[_c('p',[_v("3b2. User either re-enters the correct patient details or cancels the operation.")]),_v(" "),_c('p',[_v("Use case resumes at step 2 if patient details are re-entered.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC06 - Delete Emergency contact")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to delete the emergency contact details of a selected patient.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare asks for a patient ID of the patient to have their emergency contact details deleted.")])]),_v(" "),_c('li',[_c('p',[_v("User inputs the patient ID.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare deletes the emergency contact of the selected patient and displays a confirmation message with the deleted emergency contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. NovaCare detects that the patient does not have a registered emergency contact.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. NovaCare notifies the user that the patient already does not have a registered emergency contact.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. NovaCare detects that the patient does not exist.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3b1. NovaCare notifies the user that the patient does not exist.")])]),_v(" "),_c('li',[_c('p',[_v("3b2. User either re-enters the correct patient details or cancels the operation.")]),_v(" "),_c('p',[_v("Use case resumes at step 2 if patient details are re-entered.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: UC07 - Add Priority")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to add a priority level to a patient.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare prompts the user to select the patient.")])]),_v(" "),_c('li',[_c('p',[_v("User selects the relevant patient and chooses the desired priority level.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare updates the patient record with the chosen priority level.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare outputs a message showing successful priority update for the patient.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("3a. NovaCare detects an invalid priority level.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. NovaCare prompts the user to enter a valid priority level.")])]),_v(" "),_c('li',[_c('p',[_v("3a2. User re-enters the priority level.")]),_v(" "),_c('p',[_v("Steps 3a1-3a2 are repeated until a valid priority level is provided.\nUse case resumes at step 3 if the priority level is correct.")])])])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: UC08 - Reset Priority")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to reset the priority level for a patient.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare prompts the user to select the patient.")])]),_v(" "),_c('li',[_c('p',[_v("User selects the relevant patient to reset the priority.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare resets the priority level for the patient to the default setting.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare outputs a message confirming the successful reset of the patient's priority.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Mainstream OS")]),_v(": Windows, Linux, Unix, MacOS")]),_v(" "),_c('li',[_c('strong',[_v("Private contact detail")]),_v(": A contact detail that is not meant to be shared with others")]),_v(" "),_c('li',[_c('strong',[_v("Priority level")]),_v(": A level to rank patients in terms of their severity level")]),_v(" "),_c('li',[_c('strong',[_v("Emergency contact")]),_v(": A person who is preferably close to the patient and is designated to receive information in case of an emergency")]),_v(" "),_c('li',[_c('strong',[_v("Task")]),_v(": A task to be done for a specific patient")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Adding a task to a patient while all patients are being shown")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Patient should already exist in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addtask 1 d/Eat Medication")]),_c('br'),_v("\nExpected: Task \"Eat Medication\" is added to the task list for the patient with ID 1. Details of the added task are shown in the status message. Timestamp in the status bar is updated.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addtask 0 d/Eat Medication")]),_c('br'),_v("\nExpected: No task is added. Error details are shown in the status message indicating an invalid patient ID. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect add task commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addtask")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addtask x d/")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("addtask 1 d/")]),_v(" (where x is an invalid patient ID or description is missing)"),_c('br'),_v("\nExpected: Similar to previous. Error details are shown in the status message explaining the issue with the command input.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"changing-priority"}},[_v("Changing Priority"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#changing-priority","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Sat, 9 Nov 2024, 15:43:51 GMT+8]")])])])}
}];
