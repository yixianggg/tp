...
with(this){return _c('ol',[_c('li',[_c('p',[_v("User chooses to add a priority level to a patient.")])]),_v(" "),_c('li',[_c('p',[_v("User selects the relevant patient and chooses the desired priority level.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare updates the patient record with the chosen priority level.")])]),_v(" "),_c('li',[_c('p',[_v("NovaCare outputs a message showing successful priority update for the patient.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. NovaCare detects an invalid priority level.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. NovaCare prompts the user to enter a valid priority level.")])]),_v(" "),_c('li',[_c('p',[_v("2a2. User re-enters the priority level.")]),_v(" "),_c('p',[_v("Steps 2a1-2a2 are repeated until a valid priority level is provided.\nUse case resumes at step 3 if the priority level is correct.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Should work on any "),_c('em',[_v("mainstream OS")]),_v(" as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("Should be able to hold up to 1000 patients without a noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above average typing speed for regular English text (i.e. not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The GUI should work well for standard screen resolutions 1920x1080 and higher, and for screen scales 100% and 125%.")]),_v(" "),_c('li',[_v("The codebase should be modular, allowing easy updates or feature additions without affecting other parts of the system.")])])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"changing-priority-level"}},[_v("Changing Priority Level"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#changing-priority-level","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
